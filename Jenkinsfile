pipeline {
    ...
    stages {
        ...
        stage ('Deployment'){
            steps{  
                withKubeConfig(caCertificate: '', clusterName: 'sk-cluster', contextName: '', credentialsId: 'token', namespace: 'sk', restrictKubeConfigAccess: false, serverUrl: 'https://0E4D068285505D2D4422706BA430F8C2.yl4.us-east-1.eks.amazonaws.com') {
    // some block
